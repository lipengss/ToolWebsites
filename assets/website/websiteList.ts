...
export const websites: RouteItem[] = [
	...
	},
	{
		...
		meta: {
			...
			bgColor: '#000',
			layout: '1x1',
			description: '专注于生成用户界面的代码，专为开发人员和设计师设计。',
		},
	},
	{
		name: '火山引擎',
	...
	},
	{
		...
		classify: ['frontend', 'designer'],
		companyName: '杭州舜易广告有限公司',
		meta: {
			rank: 0,
			type: 'icon',
			value: 'app-iconfont',
			tag: ['free', 'designer', 'assets'],
			color: '#fff',
			bgColor: '#1E1E1E',
			size: 40,
			layout: '1x1',
