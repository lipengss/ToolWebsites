				...
				<el-collapse v-model="activeName" accordion>
						...
						<el-form-item label="背景切换">
							<el-space>
								...
								<el-select
									style="width: 100px"
									placeholder="时间间隔"
									v-if="setting.bg.auto"
									v-model="setting.bg.autoTime"
					...
					<el-collapse-item name="menu">
						...
						<el-form-item label="菜单位置">
							<el-radio-group v-model="setting.menuBar.position" @change="setGlobalSetting">
					...
					<el-collapse-item name="app">
						...
						<el-form-item label="最大宽度">
							<div class="slider-wrap">
								<el-slider v-model="setting.app.screenWidth" :min="40" :max="100" :step="1" @change="setGlobalSetting" />
								<el-tag type="primary">{{ setting.app.screenWidth }}{{ setting.app.unit }}</el-tag>
							</div>
						</el-form-item>
					</el-collapse-item>
